    ...
    <div className="p-4 md:p-8 lg:p-12 space-y-6">
      <header className="mb-6 border-b-2 border-primary pb-3">
        ...
        <p className="text-body-lg text-on-surface-variant mt-2">
          Establish communications with Trainer Vinayak. Submit query parameters below.
        </p>
      </header>
          ...
          {status === 'success' ? (
            <div className="p-8 text-center space-y-4">
              ...
              <p className="font-mono text-xs text-on-surface-variant max-w-sm mx-auto leading-relaxed">
                Your message has been broadcasted successfully. Trainer Vinayak will respond at his earliest convenience.
              </p>
              <div className="pt-2">
                <RetroButton variant="primary" onClick={() => setStatus('idle')}>
            ...
            <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-4 font-mono text-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label htmlFor="name" className="font-bold text-primary block uppercase">
                    Trainer Name:
                  </label>
                  <input
                    type="text"
                ...
                <div className="space-y-1.5">
                  <label htmlFor="email" className="font-bold text-primary block uppercase">
              ...
              <div className="space-y-1.5">
                <label htmlFor="subject" className="font-bold text-primary block uppercase">
              ...
              <div className="space-y-1.5">
                <label htmlFor="message" className="font-bold text-primary block uppercase">
